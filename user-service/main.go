...
import (
	"fmt"
	database "github.com/bertshang/policy/user-service/db"
	"github.com/bertshang/policy/user-service/handler"
	pb "github.com/bertshang/policy/user-service/proto/user"
	repository "github.com/bertshang/policy/user-service/repo"
...
func main() {
	...
	srv := micro.NewService(
		micro.Name("policy.service.user"),
